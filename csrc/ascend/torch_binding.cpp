...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.def("npu_chunk_gated_delta_rule(Tensor query, "
            "                            Tensor key, "
            "                            Tensor value, "
            "                            Tensor beta, "
            ...
            "                            *, "
            "                            Tensor? g=None, "
            "                            float scale_value) -> (Tensor out, Tensor final_state)");
    ops.impl("npu_chunk_gated_delta_rule", torch::kPrivateUse1, &vllm_fl::npu_chunk_gated_delta_rule);
