...
TORCH_LIBRARY_IMPL_EXPAND(CONCAT(_C, _ascend), Meta, ops) {
    ...
    ops.impl("npu_chunk_gated_delta_rule", &vllm_fl::meta::npu_chunk_gated_delta_rule_meta);
    ...
    ops.impl("npu_moe_init_routing_custom", &vllm_fl::meta::npu_moe_init_routing_custom_meta);
    // Moe_gating_top_k
