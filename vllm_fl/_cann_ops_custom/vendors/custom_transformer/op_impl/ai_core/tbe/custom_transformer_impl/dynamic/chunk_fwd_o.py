...
def chunk_fwd_o(q_in__, k_in__, v_in__, h_in__, g_in__, cu_seqlens_in__=None, chunk_offsets_in__=None, o_out_=None, scale=0.0, chunk_size=0, kernel_name="chunk_fwd_o", impl_mode = ""):
    ...
    custom_compile_options = {'__ALLSOC__': ['--cce-auto-sync=off', '-Wno-deprecated-declarations', '-Werror', '-I/workspace/Main/vllm-plugin-FL/csrc/ascend/third_party/catlass/include', '-I/workspace/Main/vllm-plugin-FL/csrc/ascend/moe/common']},
