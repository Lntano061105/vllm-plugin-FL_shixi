...
def op_select_format(x_in__, hc_fn_in__, hc_scale_in__, hc_base_in__, y_out_, post_out_, comb_frag_out_, hc_mult=4, hc_sinkhorn_iters=20, hc_eps=1e-06, norm_eps=1e-06, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, hc_fn_in__, hc_scale_in__, hc_base_in__, y_out_, post_out_, comb_frag_out_, hc_mult, hc_sinkhorn_iters, hc_eps, norm_eps)
    result = check_op_cap("op_select_format", "HcPre", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, hc_fn_in__, hc_scale_in__, hc_base_in__, y_out_, post_out_, comb_frag_out_, hc_mult=4, hc_sinkhorn_iters=20, hc_eps=1e-06, norm_eps=1e-06, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, hc_fn_in__, hc_scale_in__, hc_base_in__, y_out_, post_out_, comb_frag_out_, hc_mult, hc_sinkhorn_iters, hc_eps, norm_eps)
    result = check_op_cap("get_op_specific_info", "HcPre", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
