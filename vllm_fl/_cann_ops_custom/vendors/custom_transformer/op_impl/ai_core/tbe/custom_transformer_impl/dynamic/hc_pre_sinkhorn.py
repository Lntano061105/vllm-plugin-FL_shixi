...
def op_select_format(mixes_in__, rsqrt_in__, hc_scale_in__, hc_base_in__, x_in__, y_out_, post_out_, comb_frag_out_, hc_mult=4, hc_sinkhorn_iters=20, hc_eps=1e-06, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(mixes_in__, rsqrt_in__, hc_scale_in__, hc_base_in__, x_in__, y_out_, post_out_, comb_frag_out_, hc_mult, hc_sinkhorn_iters, hc_eps)
    result = check_op_cap("op_select_format", "HcPreSinkhorn", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(mixes_in__, rsqrt_in__, hc_scale_in__, hc_base_in__, x_in__, y_out_, post_out_, comb_frag_out_, hc_mult=4, hc_sinkhorn_iters=20, hc_eps=1e-06, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(mixes_in__, rsqrt_in__, hc_scale_in__, hc_base_in__, x_in__, y_out_, post_out_, comb_frag_out_, hc_mult, hc_sinkhorn_iters, hc_eps)
    result = check_op_cap("get_op_specific_info", "HcPreSinkhorn", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
