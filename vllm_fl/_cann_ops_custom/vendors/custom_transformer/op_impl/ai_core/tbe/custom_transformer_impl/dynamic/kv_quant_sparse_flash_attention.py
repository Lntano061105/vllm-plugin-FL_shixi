...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['query', 'key', 'value', 'sparse_indices', 'key_dequant_scale', 'value_dequant_scale', 'block_table', 'actual_seq_lengths_query', 'actual_seq_lengths_kv']
...
def _build_args(query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__, value_dequant_scale_in__, block_table_in__, actual_seq_lengths_query_in__, actual_seq_lengths_kv_in__, attention_out_out_, softmax_max_out_, softmax_sum_out_, scale_value, key_quant_mode, value_quant_mode, sparse_block_size, layout_query, layout_kv, sparse_mode, pre_tokens, next_tokens, attention_mode, quant_scale_repo_mode, tile_size, rope_head_dim, return_softmax_lse):
    __inputs__ = []
    for arg in [query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__, value_dequant_scale_in__, block_table_in__, actual_seq_lengths_query_in__, actual_seq_lengths_kv_in__]:
        if arg != None:
    ...
    if key_quant_mode != None:
        ...
        __attrs__.append(attr)
    if value_quant_mode != None:
        attr = {}
        attr["name"] = "value_quant_mode"
        attr["dtype"] = "int"
        attr["value"] = value_quant_mode
        __attrs__.append(attr)
    ...
    if attention_mode != None:
        ...
        __attrs__.append(attr)
    if quant_scale_repo_mode != None:
        attr = {}
        attr["name"] = "quant_scale_repo_mode"
        attr["dtype"] = "int"
        attr["value"] = quant_scale_repo_mode
        __attrs__.append(attr)
    if tile_size != None:
        attr = {}
        attr["name"] = "tile_size"
        attr["dtype"] = "int"
        attr["value"] = tile_size
        __attrs__.append(attr)
...
@tbe_register.register_operator("KvQuantSparseFlashAttention", trans_bool_to_s8=False)
...
def kv_quant_sparse_flash_attention(query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__=None, value_dequant_scale_in__=None, block_table_in__=None, actual_seq_lengths_query_in__=None, actual_seq_lengths_kv_in__=None, attention_out_out_=None, softmax_max_out_=None, softmax_sum_out_=None, scale_value=0.0, key_quant_mode=0, value_quant_mode=0, sparse_block_size=1, layout_query="BSND", layout_kv="BSND", sparse_mode=3, pre_tokens=9223372036854775807, next_tokens=9223372036854775807, attention_mode=0, quant_scale_repo_mode=1, tile_size=128, rope_head_dim=64, return_softmax_lse=False, kernel_name="kv_quant_sparse_flash_attention", impl_mode = ""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__, value_dequant_scale_in__, block_table_in__, actual_seq_lengths_query_in__, actual_seq_lengths_kv_in__, attention_out_out_, softmax_max_out_, softmax_sum_out_, scale_value, key_quant_mode, value_quant_mode, sparse_block_size, layout_query, layout_kv, sparse_mode, pre_tokens, next_tokens, attention_mode, quant_scale_repo_mode, tile_size, rope_head_dim, return_softmax_lse)
    ...
    custom_all_compile_options = {'__ALLSOC__': ['-Wno-ignored-attributes', '-include/workspace/Main/vllm-plugin-FL/csrc/ascend/common/include/cann_compat.h']},
    ...
    origin_func_name = "kv_quant_sparse_flash_attention"
    ascendc_src_dir_ex = "kv_quant_sparse_flash_attention"
    ascendc_src_dir = "kv_quant_sparse_flash_attention"
    ascendc_src_file = "kv_quant_sparse_flash_attention.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Ascend C Operator KvQuantSparseFlashAttention, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "KvQuantSparseFlashAttention"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__ , impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__, value_dequant_scale_in__, block_table_in__, actual_seq_lengths_query_in__, actual_seq_lengths_kv_in__], origin_outputs = [attention_out_out_, softmax_max_out_, softmax_sum_out_],\
...
def op_select_format(query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__=None, value_dequant_scale_in__=None, block_table_in__=None, actual_seq_lengths_query_in__=None, actual_seq_lengths_kv_in__=None, attention_out_out_=None, softmax_max_out_=None, softmax_sum_out_=None, scale_value=0.0, key_quant_mode=0, value_quant_mode=0, sparse_block_size=1, layout_query="BSND", layout_kv="BSND", sparse_mode=3, pre_tokens=9223372036854775807, next_tokens=9223372036854775807, attention_mode=0, quant_scale_repo_mode=1, tile_size=128, rope_head_dim=64, return_softmax_lse=False, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__, value_dequant_scale_in__, block_table_in__, actual_seq_lengths_query_in__, actual_seq_lengths_kv_in__, attention_out_out_, softmax_max_out_, softmax_sum_out_, scale_value, key_quant_mode, value_quant_mode, sparse_block_size, layout_query, layout_kv, sparse_mode, pre_tokens, next_tokens, attention_mode, quant_scale_repo_mode, tile_size, rope_head_dim, return_softmax_lse)
    result = check_op_cap("op_select_format", "KvQuantSparseFlashAttention", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__=None, value_dequant_scale_in__=None, block_table_in__=None, actual_seq_lengths_query_in__=None, actual_seq_lengths_kv_in__=None, attention_out_out_=None, softmax_max_out_=None, softmax_sum_out_=None, scale_value=0.0, key_quant_mode=0, value_quant_mode=0, sparse_block_size=1, layout_query="BSND", layout_kv="BSND", sparse_mode=3, pre_tokens=9223372036854775807, next_tokens=9223372036854775807, attention_mode=0, quant_scale_repo_mode=1, tile_size=128, rope_head_dim=64, return_softmax_lse=False, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, sparse_indices_in__, key_dequant_scale_in__, value_dequant_scale_in__, block_table_in__, actual_seq_lengths_query_in__, actual_seq_lengths_kv_in__, attention_out_out_, softmax_max_out_, softmax_sum_out_, scale_value, key_quant_mode, value_quant_mode, sparse_block_size, layout_query, layout_kv, sparse_mode, pre_tokens, next_tokens, attention_mode, quant_scale_repo_mode, tile_size, rope_head_dim, return_softmax_lse)
    result = check_op_cap("get_op_specific_info", "KvQuantSparseFlashAttention", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
