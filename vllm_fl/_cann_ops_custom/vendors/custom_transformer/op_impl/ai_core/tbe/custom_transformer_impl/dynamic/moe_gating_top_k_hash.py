...
def op_select_format(x_in__, bias_in__=None, input_ids_in__=None, tid2eid_in__=None, y_out_=None, expert_idx_out_=None, out_out_=None, k=0, k_group=1, group_count=1, group_select_mode=0, renorm=0, norm_type=0, out_flag=False, routed_scaling_factor=1, eps=1e-20, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, bias_in__, input_ids_in__, tid2eid_in__, y_out_, expert_idx_out_, out_out_, k, k_group, group_count, group_select_mode, renorm, norm_type, out_flag, routed_scaling_factor, eps)
    result = check_op_cap("op_select_format", "MoeGatingTopKHash", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, bias_in__=None, input_ids_in__=None, tid2eid_in__=None, y_out_=None, expert_idx_out_=None, out_out_=None, k=0, k_group=1, group_count=1, group_select_mode=0, renorm=0, norm_type=0, out_flag=False, routed_scaling_factor=1, eps=1e-20, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, bias_in__, input_ids_in__, tid2eid_in__, y_out_, expert_idx_out_, out_out_, k, k_group, group_count, group_select_mode, renorm, norm_type, out_flag, routed_scaling_factor, eps)
    result = check_op_cap("get_op_specific_info", "MoeGatingTopKHash", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
