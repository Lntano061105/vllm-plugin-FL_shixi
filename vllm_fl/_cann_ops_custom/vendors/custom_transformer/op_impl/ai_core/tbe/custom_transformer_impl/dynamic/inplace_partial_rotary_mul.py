...
def op_select_format(x_in__, cos_in__, sin_in__, x_out_, mode=0, partial_slice=[0,0], impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, cos_in__, sin_in__, x_out_, mode, partial_slice)
    result = check_op_cap("op_select_format", "InplacePartialRotaryMul", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, cos_in__, sin_in__, x_out_, mode=0, partial_slice=[0,0], impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, cos_in__, sin_in__, x_out_, mode, partial_slice)
    result = check_op_cap("get_op_specific_info", "InplacePartialRotaryMul", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
