...
def op_select_format(x_in__, y_out_, epsilon=1e-06, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, y_out_, epsilon)
    result = check_op_cap("op_select_format", "HcPreInvRms", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, y_out_, epsilon=1e-06, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, y_out_, epsilon)
    result = check_op_cap("get_op_specific_info", "HcPreInvRms", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
